...
public:
	static CPUTRenderStateBlockDX11* Create();
    ...
    ID3D11DepthStencilState* GetDepthStencilState() {
        return mpDepthStencilState;
    };
    ID3D11RasterizerState* GetRasterizerState() {
        return mpRasterizerState;
    };
    ...
    float* GetBlendFactor() {
        return mStateDesc.BlendFactor;
    };
    UINT GetSampleMask() {
        return mStateDesc.SampleMask;
    };
    UINT GetStencilRef() {
        return 0;
    };
...
//void SetRenderStateBlock(CPUTRenderStateBlockDX11* pNew, CPUTRenderStateBlockDX11* pOld);
